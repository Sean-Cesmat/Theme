...
if (of_get_option(BRANKIC_VAR_PREFIX . "color") != "") {
	...
	//$old_options = array("color", "logo", "logo2", "extra_images_no");
...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => __('Background images from Live prview examples are located in bigbangwp/images/pattern/', BRANKIC_THEME_SHORT),
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$options[] = array(
		...
		'desc' => __('Inset subject of the email you will receive from visitors', BRANKIC_THEME_SHORT),
		'id' => BRANKIC_VAR_PREFIX . 'email_subject',
		'std' => 'Email from my website',
		'type' => 'text');
